...
export const CHALLENGE_TEMPLATES: ChallengeTemplate[] = [
...

  {
    ...
    rules: [
      ...
      'Givta platform fee is 4% of total collected',
      'Prize distribution happens automatically to your wallet'
    ],
    howToPlay: 'Set your graduation celebration goal amount and share with your network. Every tip brings you closer to celebrating your achievement! After the challenge ends, keep 96% of all money collected in your Givta wallet.',
    winnings: 'You receive 96% of the total tips collected (after Givta\'s 4% fee and ₦100 per tip fee). For example, with ₦75,000 goal and 750 participants paying ₦100 each, you\'ll receive ₦72,000.',
    defaultAmount: 75000,
    defaultDuration: 14,
    rewardPercentage: 4,
    primaryColor: '#4B0082',
